...
@export var mobile_controls_button: Button
...
func _ready() -> void:
	...
	if GameManager.game_data.show_mobile_controls:
		mobile_controls_button.button_pressed = true
	else:
		mobile_controls_button.button_pressed = false
...
func _on_play_button_pressed() -> void:
	...
	AudioManager.play("Click")
	await pop_all()
	await SceneManager.goto_scene("res://scenes/levels/level_1.tscn")
...
func _on_mobile_controls_check_button_toggled(toggled_on: bool) -> void:
	GameManager.toggle_mobile_controls(toggled_on)
